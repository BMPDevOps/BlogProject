...
<script type="text/javascript" src="../js/newJoin.js"></script>
	...
	<form action="" method="post" enctype="multipart/form-data"	onsubmit="return check()">
		...
		<div class="form-container">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<button type="button" class="btn btn-danger btn-sm" id="btncheckid">중복확인</button>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="password" name="passwd" id="passwd" class="form-control" required maxlength="8">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="tel" name="hp" id="hp" class="form-control" required pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" placeholder="xxx-xxxx-xxxx">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="date" name="birthday" id="birthday" class="form-control" value="2024-01-01">
				</div>
			</div>
